...
public class StyleConfig {
    ...
    public static final Color PALETTE_NAVY = new Color(0x18, 0x1A, 0x2F);   // #181A2F
    public static final Color PALETTE_INDIGO = new Color(0x24, 0x2E, 0x49); // #242E49
    public static final Color PALETTE_SLATE = new Color(0x37, 0x41, 0x5C);  // #37415C
    public static final Color PALETTE_PEACH = new Color(0xFD, 0xA4, 0x81);  // #FDA481
    public static final Color PALETTE_RED = new Color(0xB4, 0x18, 0x2D);    // #B4182D
    public static final Color PALETTE_WINE = new Color(0x54, 0x16, 0x2B);   // #54162B
