...
public class PlaceholderPasswordField extends JPasswordField {
    ...
    public PlaceholderPasswordField(String placeholder, String iconText) {
        ...
        setOpaque(false);
        setBorder(BorderFactory.createEmptyBorder(13, iconText != null ? 42 : 16, 13, 44));
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (eyeBounds.contains(e.getPoint()) && !showingPlaceholder) {
                    // Button action: toggle password visibility from the eye icon.
    ...
    // Start: password visibility icon button function.
    ...
    // End: password visibility icon button function.
